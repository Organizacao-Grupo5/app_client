        ...
        try(Connection connection = MySQLConnection.ConBD()) {
            Logger.logInfo("""
                ...
                """.formatted(
                    ...
                    componente.getDadoCaptura(),
                    componente.getUnidadeMedida(),
                    LocalDateTime.now().toString(),
                    componente.getIdComponente()));

            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO captura (dadoCaptura, unidadeMedida, dataCaptura, fkComponente) VALUES (?,?,?,?)");
