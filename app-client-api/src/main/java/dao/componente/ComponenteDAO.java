        ...
        try (Connection connection = MySQLConnection.ConBD()) {
            ...
            if (!componenteExistenteNoBanco(componente, maquina)) {
                try {
                    ...
                    PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO componente (componente, modelo, fabricante, fkMaquina, fkUsuario) VALUES (?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public boolean componenteExistenteNoBanco(Componente componente, Maquina maquina) throws SQLException {
        ...
        try (Connection connection = MySQLConnection.ConBD()) {
            Logger.logInfo("""
                        ...
                        Fabricante: %s
                        Id Máquina: %d
                """.formatted(componente.getComponente(), componente.getModelo(), componente.getFabricante(), maquina.getIdMaquina()));
