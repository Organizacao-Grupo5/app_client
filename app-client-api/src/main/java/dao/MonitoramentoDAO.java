    ...
    public void salvarComponenteGPU(Integer idMaquina, GPU gpu) {
        ...
        try (Connection conexao = Connector.ConBD();
            ...
            if (resultSet.next()) {
                ...
                updateStatement.setDouble(2, gpu.getMemoria()); // Apenas passa o valor diretamente
                ...
                insertStatement.setDouble(3, gpu.getMemoria()); // Apenas passa o valor diretamente
